...
$txt="<b>MODULO DI DICHIARAZIONI DEL CLIENTE IN RELAZIONE AGLI OBBLIGHI ANTIRICICLAGGIO <br/>PREVISTI DAL D.LGS. N. 231/2007 ED AI FINI DELLA NORMATIVA SULLA PRIVACY (D. LGS. 196/2003)</b>";
// writeHTMLCell($w, $h, $x, $y, $html='', $border=0, $ln=0, $fill=0, $reseth=true, $align='', $autopadding=true)
//Cell($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=0, $link='', $stretch=0, $ignore_min_height=false, $calign='T', $valign='M')
$pdf->writeHTMLCell(190, 4, 10, $y, $txt, 0, 0, 1, true, 'C', true);
$y = $pdf->getY();
/*
...
switch ($contract['act_for_other']){
  ...
  break;
  case 2:
  $txt=strtoupper("<b>Per conto de/delle Persone fisiche</b> di cui all’allegata dichiarazione sui titolari effettivi della prestazione, nella qualità di
</b>");
